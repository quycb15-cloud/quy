...
export function parseWorkerImportRows(rawRows: Record<string, unknown>[]): PreviewRow[] {
  ...
  return rawRows.map((row, index) => {
    const parsed: WorkerImportRow = {
      ...
      phone: text(row["Số điện thoại"] ?? row["Điện thoại"]) || null,
      status: normalizeStatus(row["Trạng thái làm việc"] ?? row["Trạng thái"]),
