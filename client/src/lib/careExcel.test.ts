...
describe("parseCareWorkbook", () => {
  it("đọc mẫu Theo dõi cạo mủ có header hai tầng và tách ba nhóm Vườn", () => {
    const rows: unknown[][] = [
    ...
    const workbook = { SheetNames: ["Theo dõi cạo mủ"], Sheets: { "Theo dõi cạo mủ": XLSX.utils.aoa_to_sheet(rows) }, utils: XLSX.utils, SSF: XLSX.SSF };
