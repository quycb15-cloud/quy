...
const record = { activityDate: "2026-08-23T00:00:00.000Z", unit: "Đội 1", gardenName: "Vườn A", areaHa: 2.5, tappingSection: 3, workContent: "Làm cỏ", planQuantity: 10, actualQuantity: 8, cumulativeQuantity: 8, metricUnit: "Ha", progressPercent: 80, pendingGardens: 1, partialGardens: 2, nextGarden: "Vườn B", nextGardenPlanQuantity: 6, nextGardenActualQuantity: 4, note: "Đủ vật tư" };
...
describe("buildCareDailyExportRows", () => {
  it("xuất cột cạo mủ riêng với chỉ tiêu cạo", () => {
    ...
    expect(row).toMatchObject({ Vườn: "Vườn A", "Diện tích (ha)": 2.5, "Phần cạo": 3, "Chưa cạo": 1, "Cạo chưa xong": 2, "Cạo tiếp vườn": "Vườn B", "KH tiếp (Vườn)": 6, "TH tiếp (Vườn)": 4 });
  });
