...
describe("parseWorkerImportRows", () => {
  it("parses Vietnamese headers and normalizes optional fields", () => {
    const [row] = parseWorkerImportRows([{ "Đội": "Đội 1", "Họ tên": "Nguyễn Văn A", "Mã số": "CN001", "Giới tính": "Nữ", "Trạng thái": "Đang làm việc" }]);
    expect(row).toMatchObject({ unit: "Đội 1", name: "Nguyễn Văn A", employeeCode: "CN001", gender: "female", status: "active", roleTitle: "Công nhân khai thác" });
