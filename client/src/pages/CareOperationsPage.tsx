...
export default function CareOperationsPage() {
  ...
  const noteRows = useMemo(() => {
    ...
    orderedRecords.forEach(row => {
      ...
      if (!note) return;
      const date = new Date(row.activityDate).toLocaleDateString("vi-VN");
